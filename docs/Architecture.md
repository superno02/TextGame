...
- 管理：訊息列表、場景狀態、彈窗控制、戰鬥狀態、商店狀態
- 提供方法：moveToScene、attackMonster（完整戰鬥迴圈）、talkToNPC、buyItem、sellItem、saveGame
...
| Class | 責任 |
|-------|------|
| `PlayerCharacter` | 玩家角色持久化資料，初始屬性從 GuildTemplate 載入，含技能與背包關聯、金幣 |
...
6. ~~測試覆蓋率為零~~ → 已新增 97 個 Swift Testing 測試案例
